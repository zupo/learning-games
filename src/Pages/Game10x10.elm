module Pages.Game10x10 exposing (Model, Msg(..), page)
        ...
        GotTimestamp posix ->
            ...
            , Effect.sendCmd
                (Lamdera.sendToBackend
                    (Bridge.SubmitScore "10x10" model.playerName model.timer model.mistakes (Time.posixToMillis posix))
                )
            )
        ...
        [ div
            ...
            , div []
                    ...
                    div
                        ...
                        , if not model.scoreSaved then
                            ...
                            div []
                                ...
                                , viewLeaderboard shared.leaderboard10x10
                                ]
                        ]
                ...
                , div
                    ...
                    [ text ("Progress: " ++ String.fromInt (Set.size model.clickedCells) ++ "/100 cells") ]
                , div
                    [ css
                        [ Tw.text_center
                        , Tw.mt_2
        ...
        [ div
              ...
              div
                ...
                [ -- Column headers
                  div
                    ...
                    (List.map (viewColumnHeader model) (List.range 1 10))
                , -- Cell rows
                  div []
                    (List.map (viewRowCells model) (List.range 1 10))
                ]
            , -- Row headers positioned absolutely to the left
              div
                ...
                (div [ css [ Tw.w_12, Tw.h_12, Tw.m_1 ] ] [] :: List.map (viewRowHeader model) (List.range 1 10))
            ]
        ]
...
viewRowCells model rowNum =
    div
        ...
        (List.map (viewCell model rowNum) (List.range 1 10))
