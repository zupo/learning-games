module Pages.Game5x5 exposing (Model, Msg(..), page)
        ...
        GotTimestamp posix ->
            ...
            , Effect.sendCmd
                (Lamdera.sendToBackend
                    (Bridge.SubmitScore "5x5" model.playerName model.timer model.mistakes (Time.posixToMillis posix))
                )
            )
        ...
        [ div
            ...
            , div []
                    ...
                    div
                        ...
                        , if not model.scoreSaved then
                            ...
                            div []
                                ...
                                , viewLeaderboard shared.leaderboard5x5
                                ]
                        ]
                ...
                , div
                    ...
                    [ text ("Progress: " ++ String.fromInt (Set.size model.clickedCells) ++ "/25 cells") ]
                , div
                    [ css
                        [ Tw.text_center
                        , Tw.mt_2
        ...
        [ div
              ...
              div
                ...
                [ -- Column headers
                  div
                    ...
                    (List.map (viewColumnHeader model) (List.range 1 5))
                , -- Cell rows
                  div []
                    (List.map (viewRowCells model) (List.range 1 5))
                ]
            , -- Row headers positioned absolutely to the left
              div
                ...
                (div [ css [ Tw.w_12, Tw.h_12, Tw.m_1 ] ] [] :: List.map (viewRowHeader model) (List.range 1 5))
            ]
        ]
...
viewRowCells model rowNum =
    div
        ...
        (List.map (viewCell model rowNum) (List.range 1 5))
